                ...
                <div class="card-body">
                    <form action="{{ route('users.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <img style="width: 5%; float: right" src="https://cdn3.iconfinder.com/data/icons/show-and-hide-password/100/show_hide_password-07-512.png" onclick="eyeFunction()">
                            @error('password')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            <label >Email</label>
                            <input name="mail" value="{{ old('mail') }}" type="email" class="form-control @error('mail') is-invalid @enderror">
                            @error('mail')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
