...
<div class="container">
    ...
    <div class="row">
        ...
        <img style="margin: 30px 0" src="/storage/webs/DWgift.png" alt="">
    </div>
    <h3 class="h3" style="text-align: center; padding: 20px 0; text-transform: uppercase;">Find more timeless designs</h3>
...
{{--OWL--}}
<div class="container">
    <h3 class="h3" style="text-align: center; padding: 20px 0">MAYBE YOU LIKE</h3>
