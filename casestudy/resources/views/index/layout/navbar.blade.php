...
<div class="header">
    ...
    <div class="container-fluid home">
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <h5 class="title">D A N G Q U A N G  W A T C H</h5>
            </div>
            <div class="col-md-3 menu">
                <a style="font-size: 18px; float: right" href="" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-shopping-cart"></i>
    ...
    <div class="menu subHeader">
        <a href="" class="cool-link">WOMEN'S WATCHES</a>
        <a href="{{route('index.men')}}" class="cool-link">MEN'S WATCHES</a>
        <a href="" class="cool-link">JEWELRY</a>
        <a href="" class="cool-link">ON SALE</a>
        <a href="" class="cool-link">ABOUT US</a>
        <a href="" id="hide-card"><i class="fas fa-shopping-cart"></i>
            <span>(0)</span></a>
